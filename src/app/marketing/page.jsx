...
import block1 from '../../../public/assets/img7.png';
import block2 from '../../../public/assets/img8.png';
            ...
            <div className="container">
                <div className="hero-items">
                  <div className='hero-contents'>
                      <div className='career-item--top marketing-badge'>
                            <h6 className='badge-title'>Income Guarantee </h6>
                            <Image className='badge-img' src={Badge} alt='badge'/>
                      </div>
                      <h3 className='career-item--title sales-item--title'>Advanced Digital Marketing</h3>
          ...
          <div className="container">
            <div className="block-items">
              <div className="block-item">
                  <h5 className='block-title'>Advanced Digital Marketing Program details</h5>
          ...
          <div className="container">
            <div className="block-items bg-gray--dark">
              ...
              <div className="block-item block-contens">
                  <h5 className='block-title block-title--second'>Why become a Digital Marketer?</h5>
                  <ul className='block-lists'>
