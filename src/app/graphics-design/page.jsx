...
import GraphicsHero from '../../../public/assets/graphics-hero.png';
import Badge from '../../../public/assets/image-2.png';
import block1 from '../../../public/assets/img3.png';
import block2 from '../../../public/assets/img4.png';
            ...
            <div className="container">
                <div className="hero-items">
                  <div className='hero-contents'>
                      <div className='career-item--top graphice-badge'>
          ...
          <div className="container">
            <div className="block-items">
              <div className="block-item">
                  <h5 className='block-title'>Advanced Graphics Design Program details</h5>
          ...
          <div className="container">
            <div className="block-items bg-gray--dark">
              ...
              <div className="block-item block-contens">
                  <h5 className='block-title block-title--second'>Why become a Graphic Designer?</h5>
                  <ul className='block-lists'>
                  ...
                  <div className="job-item--child2">
                      <div className="item--child2--top">
                          <div className='child2-top--content'>
                              ...
                              <p className='value-off--price'>8000 BDT</p>
                              <p className='value-price'>4000 BDT</p>
                          </div>
                      </div>
